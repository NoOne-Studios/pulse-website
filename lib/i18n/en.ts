  ...
  home: {
    ...
    services: {
      ...
      four: [
        ...
        { pill: "At home", title: "Home nursing", body: "Injections, dressings, tube care, vitals." },
        { pill: "At home", title: "Home physiotherapy", body: "Post-surgery and mobility sessions." },
        { pill: "At home", title: "Home lab collection", body: "Sample taken at home, report back to you." },
      ],
      three: [
        {
          pill: "At home",
    ...
    howItWorks: {
      ...
      swipeHint: "Swipe to see all four →",
      steps: [
        { title: "Tell us what is needed", body: "A short call or a message. No forms about the patient." },
        {
    ...
    comparison: {
      ...
      subFour:
        "Compared with arranging it yourself through calls and references. The first two rows are the ones that changed: a referral from a doctor stays on the same record as the visit it leads to.",
      subThree: "Compared with arranging it yourself through calls and references.",
      onYourOwn: "On your own",
      withPulse: "With Pulse",
      rows: [
        {
          labelFour: "One record across every visit — doctor, nurse, physiotherapist, lab",
          labelThree: "One record across every visit — nursing, physiotherapy, lab collection",
          onYourOwn: "No",
          withPulse: "Yes",
          emphasize: true,
        },
        {
          labelFour: "The same people come back for repeat visits",
          labelThree: "The same people come back for repeat visits",
          onYourOwn: "Sometimes",
          withPulse: "Yes",
          emphasize: true,
        },
        {
          labelFour: "Background checked before the first visit",
          labelThree: "Background checked before the first visit",
          onYourOwn: "No",
          withPulse: "Yes",
        },
        {
          labelFour: "A replacement if someone cannot come",
          labelThree: "A replacement if someone cannot come",
          onYourOwn: "No",
          withPulse: "Yes",
        },
        {
          labelFour: "Price agreed in writing before booking",
          labelThree: "Price agreed in writing before booking",
          onYourOwn: "No",
          withPulse: "Yes",
        },
        {
          labelFour: "Someone to call when it goes wrong",
          labelThree: "Someone to call when it goes wrong",
          onYourOwn: "No",
          withPulse: "Yes",
        },
      ],
      legend: "Yes and No are written out; the tick and dash are decoration only.",
    },
    founders: {
      ...
      people: [
        {
          ...
          bio: "One or two sentences of real background. No invented credentials until the founders write their own.",
        },
        {
          name: "Founder name",
          role: "Role placeholder",
